...
/// </remarks>
public static class FluentValidationMediatorConfiguratorExtensions
{
    /// <summary>
    ...
    /// </code>
    /// </example>
    public static IMediatorConfigurator AddFluentValidation(this IMediatorConfigurator configurator)
    {
