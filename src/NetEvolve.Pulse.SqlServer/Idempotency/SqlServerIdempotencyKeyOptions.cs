...
/// <summary>
/// Configuration options for the SQL Server idempotency key store.
/// </summary>
public sealed class SqlServerIdempotencyKeyOptions
{
    /// <summary>
    /// Gets or sets the SQL Server connection string.
    /// </summary>
    /// <remarks>
    /// Required. Must be a valid SQL Server connection string.
    /// </remarks>
