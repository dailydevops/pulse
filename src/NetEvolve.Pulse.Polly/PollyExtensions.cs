...
public static class PollyExtensions
{
    ...
    /// </code>
    /// </example>
    public static IMediatorBuilder AddPollyRequestPolicies<TRequest, TResponse>(
    ...
    /// </code>
    /// </example>
    public static IMediatorBuilder AddPollyCommandPolicies<TCommand, TResponse>(
        this IMediatorBuilder configurator,
        Action<ResiliencePipelineBuilder<TResponse>> configure,
        ServiceLifetime lifetime = ServiceLifetime.Singleton
    )
    ...
    /// </code>
    /// </example>
    public static IMediatorBuilder AddPollyCommandPolicies<TCommand>(
        this IMediatorBuilder configurator,
    ...
    /// </code>
    /// </example>
    public static IMediatorBuilder AddPollyQueryPolicies<TQuery, TResponse>(
        this IMediatorBuilder configurator,
        Action<ResiliencePipelineBuilder<TResponse>> configure,
        ServiceLifetime lifetime = ServiceLifetime.Singleton
    )
    ...
    /// </code>
    /// </example>
    public static IMediatorBuilder AddPollyEventPolicies<TEvent>(
        this IMediatorBuilder configurator,
