...
/// <summary>
/// Extension methods for configuring PostgreSQL outbox services on <see cref="IMediatorConfigurator"/>.
/// </summary>
public static class PostgreSqlMediatorConfiguratorExtensions
{
    /// <summary>
    ...
    /// </code>
    /// </example>
    public static IMediatorConfigurator AddPostgreSqlOutbox(
