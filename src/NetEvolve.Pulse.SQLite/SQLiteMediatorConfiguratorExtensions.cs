...
/// <summary>
/// Extension methods for configuring SQLite outbox services on <see cref="IMediatorConfigurator"/>.
/// </summary>
public static class SQLiteMediatorConfiguratorExtensions
{
    /// <summary>
    ...
    /// </code>
    /// </example>
    public static IMediatorConfigurator UseSQLiteOutbox(
