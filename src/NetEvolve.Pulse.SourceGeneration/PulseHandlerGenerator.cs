...
public sealed class PulseHandlerGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(collected, static (spc, handlers) => Execute(spc, handlers));
    }
    ...
    /// </summary>
    private static void Execute(SourceProductionContext spc, ImmutableArray<HandlerInfo> handlers)
    {
    ...
    private static string GenerateSource(List<HandlerRegistration> registrations)
    {
        ...
        _ = sb.AppendLine();
        _ = sb.AppendLine("namespace NetEvolve.Pulse.SourceGeneration.Generated");
        _ = sb.AppendLine("{");
