...
/// <summary>
/// Extension methods for <see cref="System.Type"/> in the context of the outbox pattern.
/// </summary>
public static class TypeExtensions
{
    /// <summary>
    /// Returns the assembly-qualified name of the type for use as the outbox event type identifier.
    /// Falls back to <see cref="System.Type.FullName"/> and then <see cref="System.Type.Name"/>
